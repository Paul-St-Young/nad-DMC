  ...
  while(cur != NULL)
  {
    ...
    else if(cname == "estimator")
    {
      ...
      else if(potType == "gofr")
      {
        ...
        ParticleSet* source = (*pit).second;
        PairCorrEstimator* apot=new PairCorrEstimator(*source,sourceInp);
        apot->put(cur);
 ...
 * $Revision: 5860 $   $Date: 2013-05-20 13:54:23 -0500 (Mon, 20 May 2013) $
 * $Id: HamiltonianFactory.cpp 5860 2013-05-20 18:54:23Z jnkim $
 ***************************************************************************/
