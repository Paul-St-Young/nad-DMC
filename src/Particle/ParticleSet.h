...
bool makeRotate(const Walker_t& awalker, const ParticlePos_t& deltaR, SingleParticlePos_t& origin, RealType rangle,int axis);

bool makeShiftRotate(const ParticlePos_t& deltaR, SingleParticlePos_t& origin, SingleParticlePos_t &second );
bool invmakeShiftRotate(const ParticlePos_t& deltaR, SingleParticlePos_t& origin, SingleParticlePos_t &second);
bool gradRotate(const ParticlePos_t& deltaR, SingleParticlePos_t& origin, SingleParticlePos_t &second);
 ...
 * $Revision: 5916 $   $Date: 2013-08-05 08:27:08 -0500 (Mon, 05 Aug 2013) $
 * $Id: ParticleSet.h 5916 2013-08-05 13:27:08Z jnkim $
 ***************************************************************************/
