	...
	for (int i=0;i<3;++i)
	  {
	    ...
	    for (int k=0;k<3;++k)
	      ionCenter[k]=(DMCIons.R[1][k]+DMCIons.R[2][k])/2;	        
	    wfs2[i][0]=testGaussian(DMCIons.R[0],ionCenter,coeff_h,rc_h)
	      +testGaussian(DMCIons.R[1],DMCIons.R[2],coeff_ff,rc_ff);
	    ...
	    for (int k=0;k<3;++k)
	      ionCenter[k]=(DMCIons.R[1][k]+DMCIons.R[2][k])/2;	        
	    wfs2[i][1]=testGaussian(DMCIons.R[0],ionCenter,coeff_h,rc_h)
	      +testGaussian(DMCIons.R[1],DMCIons.R[2],coeff_ff,rc_ff);
