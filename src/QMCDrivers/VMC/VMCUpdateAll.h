...
class VMCUpdateAllWithIons: public QMCUpdateBase
{
public:
  /// Constructor.
...
private:
  /// Copy Constructor (disabled)
 VMCUpdateAllWithIons(const VMCUpdateAllWithIons& a): QMCUpdateBase(a), VMCIons(a.VMCIons) { }
  /// Copy operator (disabled).
  VMCUpdateAllWithIons& operator=(const VMCUpdateAllWithIons&)
  {
    return *this;
  }
 bool Restart;
